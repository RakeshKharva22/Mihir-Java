		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">					
					...
					<div class="col-md-7">
						<!-- Billing Details -->
						<form name="user" action="UserController" method="post">
						<div class="billing-details">
							...
							<div class="form-group">
								<textarea class="input" rows="10" cols="15" name="address" placeholder="Address"></textarea>			
								
							</div>							
							<div class="form-group">
								<input class="btn btn-danger" type="submit" name="action" value="Register">
							</div>
						</div>
						<!-- /Billing Details -->
					</form>
