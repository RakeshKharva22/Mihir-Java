				...
				<div class="row">					
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								<input class="input" type="text" name="product_model" placeholder="Product Model">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<textarea class="input" rows="10" cols="15" name="product_desc" placeholder="Product Description"></textarea>								
							</div>							
